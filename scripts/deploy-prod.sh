...
BIGQUERY_QUEUE_READ_BATCH="${BIGQUERY_QUEUE_READ_BATCH:-2000}"
BIGQUERY_MAX_RETRIES="${BIGQUERY_MAX_RETRIES:-5}"
BIGQUERY_QUEUE_SHARDS="${BIGQUERY_QUEUE_SHARDS:-16}"
...
REDIS_DEDUPE_TTL_SECONDS="${REDIS_DEDUPE_TTL_SECONDS:-86400}"
REQUEST_QUEUE_BRIDGE_MAX_FILES_PER_RUN="${REQUEST_QUEUE_BRIDGE_MAX_FILES_PER_RUN:-4}"
REQUEST_QUEUE_ROTATE_MIN_BYTES="${REQUEST_QUEUE_ROTATE_MIN_BYTES:-524288}"
REQUEST_QUEUE_ROTATE_MAX_AGE_MS="${REQUEST_QUEUE_ROTATE_MAX_AGE_MS:-500}"
...
for i in $(seq 1 "$APP_REPLICAS"); do
  ...
  docker run -d \
    ...
    -e REDIS_DEDUPE_TTL_SECONDS=${REDIS_DEDUPE_TTL_SECONDS} \
